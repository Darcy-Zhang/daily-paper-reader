...
PRIMARY_LLM_BASE_URL = "https://dashscope.aliyuncs.com/compatible-mode/v1"
DEFAULT_BLT_BASE_URL = "https://dashscope.aliyuncs.com/compatible-mode/v1"
...
class ClientFactory:
    ...
    def from_env():
        ...
        if provider in ('blt', 'bltcy', 'plato'):
            return BltClient(api_key=api_key or os.getenv('BLT_API_KEY', ''), model=model, base_url=base_url or os.getenv('BLT_API_BASE', 'https://dashscope.aliyuncs.com/compatible-mode/v1'))
